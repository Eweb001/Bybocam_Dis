...
class BlokedViewController: UIViewController,UITableViewDelegate,UITableViewDataSource
{
    ...
    func FevouriteUserApi()
    {
        ...
        ApiHandler.PostModelApiPostMethod(url: BLOCKED_USERLIST, parameters: para, Header: [ : ]) { (respData, error) in
