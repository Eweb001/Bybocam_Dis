...
// } // Close Static Function
 ...
 window.rootViewController?.present(alert, animated: true, completion: nil)
    ...
    static func PostModelApiPostMethod(url:String,parameters:[String:Any] ,Header:[String:String] , completion: @escaping (_ data:Data? ,  _ error:Error?) -> Void)
    {
        ...
        manager.request(url, method: .post, parameters: parameters, encoding: URLEncoding.default, headers: nil).responseJSON{ (response:DataResponse<Any>) in
            debugPrint(response)
    ...
    static func PostModelApiPostMethod2(url:String,parameters:[String:Any] ,Header:[String:String] , completion: @escaping (_ data:Data? ,  _ error:Error?) -> Void)
    {
        print(url)
        print(parameters)
...
class ApiHandler: NSObject
{
    ...
    static func ModelApiPostMethod(url:String,parameters:[String:Any] , completion: @escaping (_ data:Data? ,  _ error:Error?) -> Void)
    {
        print(url)
        print(parameters)
    ...
    static func apiDataGetMethod(url:String , completion: @escaping (_ data:[String:Any]? ,  _ error:Error?) -> Void)
    {
        print(url)
